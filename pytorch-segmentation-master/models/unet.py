...
class UNet(BaseModel):
    def __init__(self, num_classes, in_channels=3, freeze_bn=False,  freeze_backbone=False, **_):
...
class UNetResnet(BaseModel):
    def __init__(self, num_classes, in_channels=3, backbone='resnet50', pretrained=False, freeze_bn=False, freeze_backbone=False, **_):
